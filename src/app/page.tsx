...
const P = {
  ...
  content: {
    fr: {
      ...
      features: [
        { icon: "🔗", title: "Agregation multi-source", desc: "Connectez Typeform, Intercom, App Store, Google Play et vos CSV. UXForge normalise et unifie tous vos feedbacks en un seul flux analyse." },
        { icon: "🔥", title: "Detection des friction points", desc: "L'IA correle verbatims qualitatifs et donnees comportementales pour localiser precisement les points de blocage dans vos parcours utilisateurs." },
        { icon: "🎯", title: "Recommandations actionnables", desc: "Plan de correction priorise avec scoring effort/impact pour chaque recommendation. Pret a partager avec votre equipe produit en un clic." },
      ],
      steps: [
        { num: "01", title: "Connectez vos sources de feedback", desc: "Branchez Typeform, Intercom, App Store ou importez un CSV. UXForge normalise les formats et deduplique automatiquement les entrees similaires." },
        ...
        { num: "03", title: "Recevez votre plan d'action", desc: "Un rapport structure avec recommandations classees P1 a P4, estimations d'effort et maquettes de correction suggerees — livrable a votre equipe produit." },
      ],
      persuasion: {
        sectionTag: "Pourquoi maintenant",
        title: "Le silence de vos utilisateurs vous coute des millions.",
        paragraphs: [
          { type: "pathos", text: "Mardi 15h32. Votre CPO ouvre la cinquieme reunion de la journee : reduire le churn. L'analyste produit fait defiler 1 800 lignes de verbatims Intercom. Quelqu'un dit : 'On devrait demander aux clients ce qui ne va pas.' Vous avez deja 4 200 reponses Typeform, 11 000 reviews App Store et 38 000 messages support — dormants, illisibles, jamais lus. Le designer note 'audit UX' sur le post-it. Personne ne sait par ou commencer. Pendant ce temps, 23% de vos nouveaux utilisateurs abandonnent au meme ecran depuis huit mois, et vous payez 47€ de CAC chacun pour qu'ils partent." },
          { type: "logos", text: "Forrester calcule qu'un dollar investi en UX rapporte 100$ en retour (ROI 9 900%), et que 67% des problemes UX qui causent du churn ne sont jamais remontes a l'equipe produit. Nielsen Norman Group estime que les entreprises analysant systematiquement le feedback utilisateur reduisent leur churn de 34% sur 12 mois. Le probleme n'est pas la quantite de feedback — c'est l'incapacite humaine a traiter 1 000 verbatims par jour sans biais ni epuisement." },
          { type: "ethos", text: "Wikolabs construit des agents IA en production depuis 2023 pour des scale-ups B2B, family offices et fintechs reglementees. Nous avons brule nos doigts sur les memes problemes que vous : pipelines qui hallucinent, briefs ignores, dashboards desertes. UXForge est ce que nous avons construit pour nos propres clients exigeants avant de le proposer au marche." },
          { type: "solution", text: "Concretement : vous branchez vos sources (Typeform, Intercom, App Store, CSV) en 10 minutes. UXForge analyse 1 000 feedbacks, cluster les themes, score la criticite et livre un plan d'action classe P1 a P4 — chaque recommandation avec son effort/impact estime. Resultat : 80% de temps de recherche en moins, 67% des friction points enfin visibles, votre equipe produit corrige les vrais bloqueurs au lieu de deviner." },
        ],
      },
    ...
    en: {
      langLabel: "EN",
      tagLabel: "UX Research · AI feedback · Friction points",
      taglines: ["1,000 feedbacks analyzed.", "Friction points detected.", "In 10 minutes."],
      taglineAccentIdx: 2,
      desc: "UXForge aggregates user feedback from every source, automatically detects friction points and generates a prioritized fix plan — no manual analysis effort.",
      navLinks: [
      ...
      metrics: [
        { value: "1,000", label: "feedbacks in 10 min" },
        { value: "67%", label: "UX issues undetected" },
        { value: "-80%", label: "research time" },
        { value: "4+", label: "sources connected" },
      ],
      features: [
        { icon: "🔗", title: "Multi-source aggregation", desc: "Connect Typeform, Intercom, App Store, Google Play and your CSVs. UXForge normalizes and unifies every feedback into a single analyzed stream." },
        { icon: "🔥", title: "Friction point detection", desc: "AI correlates qualitative verbatims with behavioral data to pinpoint blockers in your user journeys." },
        { icon: "🎯", title: "Actionable recommendations", desc: "Prioritized fix plan with effort/impact scoring on each recommendation. Ready to share with your product team in one click." },
      ],
      steps: [
        { num: "01", title: "Connect your feedback sources", desc: "Plug Typeform, Intercom, App Store or upload a CSV. UXForge normalizes formats and automatically deduplicates similar entries." },
        { num: "02", title: "AI analyzes and ranks issues", desc: "Theme clustering, severity scoring and behavioral correlation. Friction points surface with their frequency and estimated impact." },
        { num: "03", title: "Receive your action plan", desc: "A structured report with recommendations ranked P1-P4, effort estimates and suggested fix wireframes — handover-ready for your product team." },
      ],
      persuasion: {
        sectionTag: "Why now",
        title: "Your users' silence is costing you millions.",
        paragraphs: [
          { type: "pathos", text: "Tuesday, 3:32 PM. Your CPO opens the fifth meeting of the day: cut churn. The product analyst scrolls 1,800 lines of Intercom verbatims. Someone says: 'We should ask customers what's wrong.' You already have 4,200 Typeform answers, 11,000 App Store reviews and 38,000 support messages — dormant, unreadable, never opened. The designer writes 'UX audit' on a post-it. No one knows where to start. Meanwhile, 23% of your new users drop off at the same screen for eight months, and you pay €47 CAC each just for them to leave." },
          { type: "logos", text: "Forrester calculates a 100x ROI on every dollar invested in UX (9,900% return), and 67% of UX issues that cause churn never reach the product team. Nielsen Norman Group estimates that companies systematically analyzing user feedback cut churn by 34% over 12 months. The problem isn't feedback volume — it's the human inability to process 1,000 verbatims a day without bias or exhaustion." },
          { type: "ethos", text: "Wikolabs has been building production AI agents since 2023 for B2B scale-ups, family offices and regulated fintechs. We burned our fingers on the same problems you face: hallucinating pipelines, ignored briefs, abandoned dashboards. UXForge is what we built for our own demanding customers before bringing it to market." },
          { type: "solution", text: "Concretely: you plug your sources (Typeform, Intercom, App Store, CSV) in 10 minutes. UXForge analyzes 1,000 feedbacks, clusters themes, scores severity and ships an action plan ranked P1-P4 — each recommendation with estimated effort/impact. The outcome: 80% less research time, 67% of friction points finally visible, your product team fixes the real blockers instead of guessing." },
        ],
      },
      ctaTitle: "Understand your users 10x faster",
      ctaDesc: "Connect your feedback sources and get your first UX analysis report in under 10 minutes. No credit card.",
      ctaPrimary: "Book a call",
      ctaWhatsApp: "WhatsApp",
      ctaDemo: "Request a demo",
      ctaSoonBadge: "Soon",
      footerTagline: "AI UX research agent for product teams",
    },
  },
};
